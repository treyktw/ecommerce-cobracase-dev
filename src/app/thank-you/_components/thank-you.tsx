...
const ThankYou = () => {
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:-y-24 lg:px-8">
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCobra believes that a phone case doesn&apos;t only need
        ...
        <div className="">
          ...
          <div className="grid grid-cols-2 gap-x-67 border-t border-zinc-200 py-10 text-sm">
            <div className="">
